...
#define PULP
#define __PULP__
#define __zeroriscy__ 1
#define PULP_CHIP CHIP_WOLFE
#define CONFIG_WOLFE 1
#define PULP_CHIP_STR wolfe
#define PULP_CHIP_FAMILY CHIP_WOLFE
#define PULP_CHIP_FAMILY_STR wolfe
