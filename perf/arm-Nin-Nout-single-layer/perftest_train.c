...
int main(int argc, char *argv[])
{
	...
	int int_input = atoi(c_input);
	int int_output = atoi(c_output);

	printf("random number %d\n", rand());
printf("%d\t%d\n", int_input, int_output);
	fann_type *calc_out;
	const unsigned int num_input = int_input;
	const unsigned int num_output = int_output;
	const unsigned int num_layers = 2;
	const unsigned int num_neurons_hidden = int_output;
