...
if __name__ == '__main__':
    ...
    for n_layers in range(1, 41, 1):
        ...
        if args_dict["activ"]: # True, i.e. use activation
            os.system("python3 generate.py -i ./perf/arm-vs-num-layers/perftest_float -p arm --activation")
        else:
            os.system("python3 generate.py -i ./perf/arm-vs-num-layers/perftest_float -p arm --no-activation")
