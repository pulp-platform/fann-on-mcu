...
RT_CL_DATA enum fann_activationfunc_enum
{
    FANN_LINEAR = 0,
    FANN_THRESHOLD,
...
*/
RT_CL_DATA enum fann_train_enum
{
...
*/
RT_CL_DATA enum fann_stopfunc_enum
{
    FANN_STOPFUNC_MSE = 0,
    FANN_STOPFUNC_BIT
};
...
*/
RT_CL_DATA enum fann_errorfunc_enum
{
    FANN_ERRORFUNC_LINEAR = 0,
    FANN_ERRORFUNC_TANH
};

RT_CL_DATA enum fann_nettype_enum
{
...
*/
RT_CL_DATA enum fann_errno_enum
{
    FANN_E_NO_ERROR = 0,
